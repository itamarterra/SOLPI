...
1.  **Fase 1 (Core SIIP)**: Modelos canônicos e Repositories de Grafo com suporte a versionamento.
2.  **Fase 2 (Discovery Base)**: Implementação de SNMP e ICMP Scanner agnóstico.
