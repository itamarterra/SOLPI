...
- Local smoke tests for batch metadata, API envelope, summary aggregation, SQL adapter pagination, CSV/XML adapter parsing, and worker failure replay handling.
